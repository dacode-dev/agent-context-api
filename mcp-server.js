...
import { z } from "zod";
import { analyzeContext } from "./server.js";

export const LOCAL_MAX_INPUT_CHARS = 12_000;
export const PAID_ENDPOINT = process.env.PAID_ENDPOINT || "https://github.com/dacode-dev/agent-context-api#paid-http-api";

export function createMcpServer() {
  const server = new McpServer({ name: "agent-context-api", version: "0.1.0" });
  server.registerTool(
    "preflight_context",
    {
      description:
